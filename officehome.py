...
label_dom1=[]
class_names1=[]
path_dom1='./data/officehome/'+domains[0]+'/train'
...
label_dom2=[]
class_names2=[]
path_dom2='./data/officehome/'+domains[1]+'/train'
...
label_dom3=[]
class_names3=[]
path_dom3='./data/officehome/'+domains[2]+'/train'
...
test_label_dom=[]
test_domain_names=[]
test_path_dom='./data/officehome/'+domains[3]+'/val'
...
best_open_set_acc = 0
best_avg_acc = 0
accuracy_file_path = "./results/officehome/realworld.txt"  
...
for epoch in range(num_epochs):
    ...
    TRAIN_MODEL_PATH = Path("./train_models/officehome/realworld")
    TRAIN_MODEL_PATH.mkdir(parents=True, exist_ok=True)
    TRAIN_MODEL_NAME = f"realworld_{epoch+1}.pth"
    ...
    MODEL_PATH = "./train_models/officehome/realworld"
    MODEL_NAME = f"realworld_{epoch+1}.pth"
